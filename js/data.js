...
// ---------- Armor trims ----------
// Order matches the in-game smithing template list. Colors are used for
// swatches and tooltip text (real trim visuals come from game textures).
const TRIM_PATTERNS = {
  sentry:    { name: "Sentry"    },
  dune:      { name: "Dune"      },
  coast:     { name: "Coast"     },
...
const TRIM_MATERIALS = {
  amethyst:  { name: "Amethyst",     color: "#9a5cc6" },
  copper:    { name: "Copper",       color: "#c06f45" },
  diamond:   { name: "Diamond",      color: "#6eecd2" },
  emerald:   { name: "Emerald",      color: "#17c144" },
  gold:      { name: "Gold",         color: "#ecd93f" },
  iron:      { name: "Iron",         color: "#c9c9c9" },
  lapis:     { name: "Lapis Lazuli", color: "#33619c" },
  netherite: { name: "Netherite",    color: "#6a5c5c" },
  quartz:    { name: "Quartz",       color: "#e6dfd5" },
  redstone:  { name: "Redstone",     color: "#c81e1e" },
  resin:     { name: "Resin Brick",  color: "#e07a28" },
};
